...
let teacherDolgor = {
    ...
    introduction: function(){
        console.log(`Миний нэрийг ${this.lastName}-ийн ${this.firstName} гэдэг. Би ${this.age} настай. Би ${this.experience} жилийн ажлийн туршилгатай. Би ${this.address.district}-т амьдардагв`)
    },
}
